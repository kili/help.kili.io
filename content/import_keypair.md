...
2. On the dashboard, open the launch Instance modal from either:-
    ...
    * The Access & Security tab in the [launch instance](launch_an_instance.html) modal form.<br>
        <br><img src="https://raw.githubusercontent.com/dguitarbite/help.kili.io/master/content/img/Select_Access_Security.png" alt="Access & Security Panel" height="2500" width="673"></img><br><br>
        + Click on Import Keypair button.<br>
            <br><img src="https://raw.githubusercontent.com/dguitarbite/help.kili.io/master/content/img/Import_Keypair.png" alt="Import Keypair" height="500" width="462"></img><br><br>
        + Keypair Details will be displayed as shown in the image below.<br>
            <br><img src="https://raw.githubusercontent.com/dguitarbite/help.kili.io/master/content/img/Import_Successful.png" alt="Confirm Keypair Import" height="2500" width="675"></img><br>
3. Once your have your Import Keypair modal, provide a name you will recognise for the key and paste the contents of your public key file into the public key text field.<br>
    <br><img src="https://raw.githubusercontent.com/dguitarbite/help.kili.io/master/content/img/instance_access_n_security.png" alt="Import/Select Keypair" height="1500" width="658"></img><br>
